...
if __name__ == "__main__":
    ...
    fcn_model = FCNs(pretrained_net=vgg_model, n_class=6)
    ...
    for epo in range(100):
        ...
        for item in dataloader:
            ...
            #iter_loss = [v.loss for v in loss]
            iter_loss = loss.item()
            print(iter_loss)
            epo_loss += iter_loss
            optimizer.step()
        ...
        if np.mod(saving_index, 30)==1:
            torch.save(fcn_model, 'checkpoints/6_way+fcn_model_{}.pt'.format(epo))
